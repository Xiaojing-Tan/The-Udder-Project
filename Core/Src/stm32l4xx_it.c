...
void EXTI9_5_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(Gripper_encoder_ChA_Pin);
  HAL_GPIO_EXTI_IRQHandler(Gripper_encoder_ChB_Pin);
  HAL_GPIO_EXTI_IRQHandler(Motor_encoder_ChA_Pin);
  HAL_GPIO_EXTI_IRQHandler(Motor_encoder_Ch9_Pin);
