...
extern _Bool last_state1A;
extern _Bool last_state2A;
/* USER CODE END PV */
...
if(last_state1A!=HAL_GPIO_ReadPin(GPIOA,GPIO_PIN_6))
{
	...
	last_state1A = HAL_GPIO_ReadPin(GPIOA,GPIO_PIN_6);
	Angle1 = CNT1/512;
}
		
if(last_state2A!=HAL_GPIO_ReadPin(GPIOA,GPIO_PIN_1))
{
	...
	last_state1A = HAL_GPIO_ReadPin(GPIOA,GPIO_PIN_1);
	Angle1 = CNT1/2000;
